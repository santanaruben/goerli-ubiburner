...
/**
 * @title UBI V2 Interface
 * @dev See https://goerli.etherscan.io/address/0xf261c4f93d1b2991bB47e7F295AF3B2Fc17BD440 This will allow us to see the UBI balance of our contract (burned UBI)
 */
interface IUBI {
...
contract UBIburner {
    ...
    /// @dev address of UBI V2 token.
    address private constant UBI = 0xf261c4f93d1b2991bB47e7F295AF3B2Fc17BD440;
